...
export class PipelineHtmlBuilder {
    ...
    return `
      <div>
        ...
        <div class="step-input-container">
            ...
            <select style="width: 100%;" class="step-input" df-inputs-branch>
  ...
  private getStringInput(key: string, data: any) {
    return `
      <div class="light-text">${key}</div>
      <input style="width: calc(100% - 20px);" class="step-input" type="text" value="${data[key].value}" df-inputs-${key}-value>
    `;
  }
  ...
  private getChoiceInput(key: string, data: any) {
    return `
        ...
        <select style="width: 100%;"
                class="step-input" df-inputs-${key}-value>
  ...
  private getNumberInput(key: string, data: any) {
    return `
      <div class="light-text">${key}</div>
      <input style="width: calc(100% - 20px);" class="step-input" type="number" value="${data[key].value}" df-inputs-${key}-value>
    `;
  }
